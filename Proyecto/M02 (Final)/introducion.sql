...
insert into personajes(nombre,usuariocreacion) values ("Alvaro",user());
...
,"Despiertas tras una pesadilla, la noche es tranquila y intentas relajarte despues de el susto, al conseguir calmarte escuchas ruido fuera de tu piso. Que hace"
,"1","Naharro","Naharro","1");
...
insert into pasos(id_paso,id_aventura,paso,num_paso,usuariocreacion,usuariomodificacion, final) 
values (id_paso,(select id_aventura from aventura where nombre_aventura="Death is Death")
,"Sales rápido de casa a buscar a tus padres pero nada mas salir te encuentras con alguien caminando de manera errática por los pasillo, al verte grita y corre hacia ti. Que hace"
...
insert into pasos(id_paso,id_aventura,paso,num_paso,usuariocreacion,usuariomodificacion, final) 
values (id_paso,(select id_aventura from aventura where nombre_aventura="Death is Death")
,"Huyes subiendo las escaleras hasta llegar a la azotea pero al intentar abrir la puerta esta cerrada por lo que el zombie que te perseguía al cual tras el ruido de la carrera ahora no solo es uno, te acorralan contra la puerta, devorándote. Tus gritos se escuchan por todo el edificio."
,"1112","Naharro","Naharro","0");

insert into pasos(id_paso,id_aventura,paso,num_paso,usuariocreacion,usuariomodificacion, final) 
values (id_paso,(select id_aventura from aventura where nombre_aventura="Death is Death")
,"Esperas en casa durante todo el dia pero ello no vuelven, te asomas a la venta para ver si puedes ver algo mas de fuera, al mirar por la ventana ves que la situacion ha empeorado ves gente corriendo y gritando por la calles, al ver esa escena cieras la persiana. Que hace"
...
insert into pasos(id_paso,id_aventura,paso,num_paso,usuariocreacion,usuariomodificacion,final) 
values (id_paso,(select id_aventura from aventura where nombre_aventura="Death is Death")
,"Antes de salir buscas en tu casa algo para defenderte, coges un cuchillo de la cocina y sales de casa. Pero nada mas salir te encuentras con alguien caminando de manera errática por los pasillo, al verte grita y corre hacia ti. Que hace"
...
insert into pasos(id_paso,id_aventura,paso,num_paso,usuariocreacion,usuariomodificacion,final) 
values (id_paso,(select id_aventura from aventura where nombre_aventura="Death is Death")
,"Te levantas de la cama para ir a ver que ha pasado, al salir de tu cuarto encuentras a tu madre y padre despierto llendo a mirar que pasa. Que hace"
,"12","Naharro","Naharro","1");

insert into pasos(id_paso,id_aventura,paso,num_paso,usuariocreacion,usuariomodificacion,final) 
values (id_paso,(select id_aventura from aventura where nombre_aventura="Death is Death")
,"Vas con ellos a mira que ha pasado al salir de casa algo ataca a tu madre, tu y tu padre vais a ayudarla, causando que os noqueen a ti y a tu padre, dejando a merced de lo que pase a los dos."
...
"Ignoras el ruido e intentas volver a domir.",11,"Naharro","Naharro","1");
...
insert into respuesta(id_respuesta,id_aventura,respuesta,num_respuesta,usuariocreacion,usuariomodificacion,id_paso) values (id_respuesta,(select id_aventura from aventura where nombre_aventura="Death is Death"),
"Esperar en casa a que vuelvan.",112,"Naharro","Naharro","2");

insert into respuesta(id_respuesta,id_aventura,respuesta,num_respuesta,usuariocreacion,usuariomodificacion,id_paso) values (id_respuesta,(select id_aventura from aventura where nombre_aventura="Death is Death"),
"Coger algo para defenderte y salir a buscarlos.",113,"Naharro","Naharro","2");
